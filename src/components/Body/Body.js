...
const Body = () => {
  ...
  return (
    <div className="Search">
      ...
      <h1 className="h1">Restaurants List</h1>
  ...
  return (
    <div className="restaurant-card">
      ...
      <div className="restaurant-detail">
        <div>
          <h3 className="p-1 m-1 font-bold text-lg">{name}</h3>
          <h4 className="text-gray-500 text-balance m-1">{cuisines}</h4>
        </div>
        <div>
          <div className="display flex bg-green-600 justify-between w-12 h-7 p-1 m-2 text-white items-center rounded-sm text-center">
            <h4>{rating}</h4>
            <svg 
          ...
          <h5 className="text-gray-500 text-sm text-balance text-center">{cost}</h5>
        </div>
      </div>
    </div>
  );
